...
export default function ResumeHeader() {
    ...
    const saveAsTemplate = async () => {
        ...
        formData.set("schema", JSON.stringify(resumeDraftSchema));
        formData.set("settings", JSON.stringify(settings));
        formData.set("distribution", JSON.stringify(distribution));
    ...
    const downloadActiveResume = () => {
        ...
        if (selectedResume?.id) {
            window.location.href = `/api/resume/download-template/${selectedResume.id}`;
        }
    };
