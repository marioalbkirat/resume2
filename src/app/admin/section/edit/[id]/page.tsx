...
export default function Page() {
    ...
    const handleSubmit = async () => { if (!section || !builderData || typeof params.id !== "string") return; if (!name.trim()) return alert("Section name is required"); await updateSection(params.id, { name: name.trim(), target: "RESUME", visibility: "OFFICIAL", schema: builderData.schema, content: builderData.content }); router.push("/admin/section/"); };
